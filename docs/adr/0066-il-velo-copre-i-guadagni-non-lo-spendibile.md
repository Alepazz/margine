...
Spese fisse attese     − 653 €
Variabili già spese    − 331 €
Puoi ancora spendere    1384 €
```
...
Il totale della barra in euro non esce dall'albero di accessibilità: `aria-valuemax` è `100` e `aria-valuenow` la percentuale impegnata. Un lettore di schermo che annunciasse «1650 su 2668» direbbe ad alta voce il numero che la pagina si rifiuta di stampare.
