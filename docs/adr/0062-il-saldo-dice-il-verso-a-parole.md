...
La prima: **il segno da solo come verso**. «`+` verde vuol dire che rientrano soldi, `−` rosso che ne escono» è vero, ma è una convenzione che bisogna già avere in testa. Chi guarda `+193 €` non legge «devo ricevere»: legge un numero verde. La frase «te li deve» era stata tolta perché stava dentro un riquadro e si leggeva come un fumetto appiccicato al numero grande (→ ADR-0059) — ma il problema era il riquadro, non la frase. «Manca una scritta come "Devi ricevere" oppure "Devi dare" che aiuta a capire.»
