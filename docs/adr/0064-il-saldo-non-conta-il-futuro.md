...
`coupleBalance` sommava tutto ciò che trovava. Una spesa datata al 15 settembre spostava il saldo di agosto, e con un affitto anticipato di mezzo — 222 € di quota — sposta il conto fra due persone di un quarto. Il numero era «vero» nel senso che il dato c'era; era falso nel senso che rispondeva a un'altra domanda.
