...
Il primo. Alessio ha riferito un importo preciso, letto su Tricount: quanto deve ricevere da Fede. Cercando quel numero nei dati, esiste, ed esiste in un solo modo: **è esattamente Spese Modem + Fattura Tim**, cioè le due voci di agosto del tricount delle spese fisse dopo l'affitto del 27 luglio. Nessuna combinazione di tricount e di date che comprenda le spese che aveva appena riportato — un sushi, una granita, un ombrellone — dà quel numero. Quel numero è il saldo di **un** tricount, non della coppia. Ed è ovvio a posteriori: **Tricount tiene un saldo per gruppo**, e quello è il numero che si legge aprendo l'app. Un totale su otto gruppi non è confrontabile con niente di ciò che si vede.
