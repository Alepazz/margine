...
La migrazione (`scripts/migrate-tricounts.mjs`) tocca 1255 spese, e ha quattro guardie: **totale generale invariato al centesimo** (60.298,29 €), **conteggio per tricount** identico a quello per origine, **saldo identico** — totale e per gruppo, ricalcolato con la stessa aritmetica prima e dopo (−49,11 €) — e i dati migrati che passano `validate-core` senza errori. Se una non torna, non scrive.
