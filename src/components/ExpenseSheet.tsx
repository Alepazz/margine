...
function MovePanel({ expense, onDone }: { expense: Expense; onDone: () => void }): ReactNode {
   ...
   * spostarla non muove niente a schermo, e la frase qui sotto — «sposta 222 €
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/*
          Il corpo scorre, testa e maniglia no. Senza questo contenitore i
          figli stanno direttamente nel foglio, che ha un tetto di altezza ma
          `overflow: visible`: il contenuto oltre il tetto veniva disegnato
          FUORI dal riquadro — la nota e gli scontrini sotto il bordo — e non
          si poteva raggiungere, perché da ADR-0048 il documento sotto non
          scorre più. Misurato prima della correzione: foglio 760px, contenuto
          1104px, ultimo figlio 345px sotto il bordo. → ADR-0030, ADR-0048
        */}
